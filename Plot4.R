setwd("C://Users/hpd/Documents/Coursera/Data Science/4. Exploratory Data Analysis/Week 1/Project")
...
## Plot (1,1)
plot(graphs$Global_active_power~graphs$TimeDay,type="l",col="black",ylab="Global Active Power",xlab="")
